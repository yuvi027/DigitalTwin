...
class Topology(Topo):
    def __init__(self):
        ...
        # Add switch links
        self.addLink("s1", "s2", intfName1="s1-eth1", intfName2="s2-eth1", **switch_link)
        ...
        # Add host links
        self.addLink("St1", "s1", intfName1="St1-eth0", intfName2="s1-eth0", **host_link)
        #self.addLink("r1", "s1", intfName1="r1-eth1", intfName2="s1-eth2", **host_link)
        self.addLink("St2", "s2", intfName1="St2-eth0", intfName2="s2-eth0", **host_link)
